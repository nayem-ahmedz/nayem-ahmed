                        ...
                        services.map((el) => {
                            return(
                                <div className='services-col' key={el.id}>
                                    ...
                                    <p> {el.details} </p>
                                    {
                                        (el.id !== 3) ? <Link to={el.link}> {el.linkText} </Link> : <a href={el.link} target="_blank" rel="noopener noreferrer"> {el.linkText} </a>
                                    }
                                </div>
                            )
                        })
